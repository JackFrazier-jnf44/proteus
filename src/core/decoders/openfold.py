...
class OpenFoldDecoder(BaseDecoder):
    """Decoder for OpenFold model outputs."""
    
    def __init__(self):
        """Initialize OpenFold decoder."""
        super().__init__('openfold')
        self.atom_types = ['N', 'CA', 'C', 'O', 'CB']  # OpenFold uses these 5 atoms
    ...
    def decode_structure(
        ...
        **kwargs
        ...
        """Decode OpenFold outputs into structure and confidence metrics.
        
        Args:
            outputs: Raw OpenFold model outputs
        ...
        try:
            ...
            logger.error(f"Failed to decode OpenFold structure: {str(e)}")
            raise DecoderError(f"Failed to decode OpenFold structure: {str(e)}")
    ...
    def decode_embeddings(
        ...
        **kwargs
        ...
        """Decode OpenFold outputs into embeddings.
        ...
        try:
            ...
            logger.error(f"Failed to decode OpenFold embeddings: {str(e)}")
            raise DecoderError(f"Failed to decode OpenFold embeddings: {str(e)}")
    ...
    def decode_confidence(
        ...
        **kwargs
        ...
        """Decode confidence scores from OpenFold outputs.
        ...
        try:
            ...
            logger.error(f"Failed to decode OpenFold confidence scores: {str(e)}")
            raise DecoderError(f"Failed to decode OpenFold confidence scores: {str(e)}") 